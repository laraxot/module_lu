...
class Container_3e0787e82f extends _PHPStan_532094bc1\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3e0787e82f $container)
			{
	...
	public function createServiceContainer(): Container_3e0787e82f
	{
		return $this;
	}
