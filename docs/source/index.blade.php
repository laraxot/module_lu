...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <h3 id="intro-laravel" class="text-2xl text-blue-900 mb-0">Templating with <br>Laravel Blade engine</h3>

            <p>Blade is a powerful, simple, and beautiful templating language, and now you can u se it for your static sites, not just your Laravel-powered apps.</p>
        </div>
